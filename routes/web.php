...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/grupos', [GrupoController::class, 'index'])->middleware('permission:grupos.gestionar')->name('grupos.index');
    Route::post('/grupos', [GrupoController::class, 'store'])->middleware('permission:grupos.gestionar')->name('grupos.store');
    Route::put('/grupos/{grupo}', [GrupoController::class, 'update'])->middleware('permission:grupos.gestionar')->name('grupos.update');
    Route::delete('/grupos/{grupo}', [GrupoController::class, 'destroy'])->middleware('permission:grupos.gestionar')->name('grupos.destroy');
    Route::post('/grupos/asignar-pc', [GrupoController::class, 'asignarPc'])->middleware('permission:grupos.gestionar')->name('grupos.asignar');
